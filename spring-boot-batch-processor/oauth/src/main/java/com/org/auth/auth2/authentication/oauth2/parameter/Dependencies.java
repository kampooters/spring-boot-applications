package com.org.auth.auth2.authentication.oauth2.parameter;
 ...
 * guarantee that the order will remain com.org.constant over time. The implementation
 ...
 *
 *
 * This implementation provides com.org.constant-time performance for the basic
