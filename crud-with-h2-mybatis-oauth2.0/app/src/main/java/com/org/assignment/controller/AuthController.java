...
import com.org.assignment.common.constants.AuthRoute;
import com.org.assignment.common.constants.BASERoute;
import com.org.assignment.dto.AuthResponseDTO;
import com.org.assignment.dto.HttpResonseDTO;
import com.org.assignment.persistence.service.impl.AuthService;
import com.org.assignment.logger.LogManager;
import com.org.assignment.security.authentication.OAuthConstant;
...
public class AuthController extends LogManager {
    ...
    @GetMapping(AuthRoute.TEST)
    public HttpResonseDTO getTestMessage() {
        requestReceived(BASERoute.BASE_ROUTE + AuthRoute.TEST, null);
        HttpResonseDTO resp = new HttpResonseDTO();
        resp.setMessage("working fine");
        requestServed(BASERoute.BASE_ROUTE + AuthRoute.TEST, resp);
        resp.setPath(BASERoute.BASE_ROUTE + AuthRoute.TEST);
        return resp;
    }
